...
interface RecentEffortItem {
  date: string;
  score: number | null;
  totalQuestions: number;
}

interface RecentEffortClientProps {
  recentEffort: RecentEffortItem[];
}

export function RecentEffortClient({ recentEffort }: RecentEffortClientProps) {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Recent Effort</h1>
        <p className="text-muted-foreground">
          Your performance across all question sets. Scroll to see more.
        </p>
      </div>
